...
@ccclass
export default class BlockTeam_T extends BlockTeam  {
    ...
    static BlockTeam_T()
    {
        ...
        var vPos1 : number[][] = [
            ...
            BlockTeam_T.ms_RotPosData.push(vPos1);
    ...
    {
        var bt:BlockTeam = new BlockTeam_T();
    ...
    protected GetRotData(): Array<number[][]> { return BlockTeam_T.ms_RotPosData; }
}
